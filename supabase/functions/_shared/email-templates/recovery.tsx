...
export const RecoveryEmail = ({ confirmationUrl }: RecoveryEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Reset your Locus password</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          We got a request to reset the password on your Locus account. Click below to set a new one.
        </Text>
        ...
        <Text style={footer}>
          Didn't request this? You can safely ignore — your password stays the same.
        </Text>
      </Container>
    </Body>
  </Html>
