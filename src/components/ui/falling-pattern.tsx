...
type FallingPatternProps = React.ComponentProps<"div"> & {
  /** Primary color of the falling elements (default: 'hsl(var(--accent))') */
  color?: string;
...
export function FallingPattern({
  ...
  return (
    ...
    >
      ...
      />
      {/* Soft blur/vignette overlay for legibility */}
      <div
        ...
        style={{
          ...
          background:
            "radial-gradient(ellipse at center, transparent 0%, hsl(var(--background) / 0.6) 80%)",
        }}
      />
    </div>
  );
